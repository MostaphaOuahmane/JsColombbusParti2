// coucou();
//ATTENTION évitons de déclarer plusieurs variables dans différents espaces en utilsant un même nom : ici on le fait pour la démo !!!
function porteNew () {
    let xLet = 1;
    var yVar = 2;
    ...
    document.getElementById('p4').innerHTML =  'la variable "yVar" hors du if ' + yVar;//yVar affichera la dernière valeur déclarée car var a une portée élargie
}// fin fonction
porteNew()
